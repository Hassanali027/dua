    ...
    <div class="settings-card">
        <form action="{{ route('admin.category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" class="form-control" required placeholder="e.g. Ready to Wear" value="{{ old('name', $category->name) }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="slug" name="slug" class="form-control" placeholder="e.g. ready-to-wear" value="{{ old('slug', $category->slug) }}">
            ...
            <div class="form-group">
                ...
                @if($category->image_path)
                    <div style="margin-bottom: 10px;">
                        <img src="{{ asset($category->image_path) }}" alt="Current Image" style="height: 100px; border-radius: 4px;">
                    </div>
                @endif
            ...
            <div class="form-group" style="margin-top: 20px;">
                <label style="display: flex; align-items: center; cursor: pointer; font-weight: 500;">
                    <input type="checkbox" name="show_in_navbar" value="1" {{ old('show_in_navbar', $category->show_in_navbar) == '1' ? 'checked' : '' }} style="margin-right: 10px; width: 16px; height: 16px;">
            ...
            <div class="form-group">
                ...
                <input type="text" id="meta_title" name="meta_title" class="form-control" placeholder="e.g. Best Ready to Wear Dresses" value="{{ old('meta_title', $category->meta_title) }}">
                <small style="color: #6b7280; font-size: 12px; margin-top: 5px; display: block;">Leave empty to use category name.</small>
            </div>

            <div class="form-group">
                <label for="meta_description">Meta Description (SEO)</label>
                <textarea id="meta_description" name="meta_description" class="form-control" rows="3" placeholder="Brief description for search engines...">{{ old('meta_description', $category->meta_description) }}</textarea>
            </div>
